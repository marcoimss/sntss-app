...
import { ArrowLeft, Calculator, Calendar } from 'lucide-react-native';

const { width, height } = Dimensions.get('window');

export default function Calculadora2Julio({ navigation }: any) {
    ...
    const calcular = () => {
        ...
        // Fórmula: (c02 + c11) * 2 * 46 / 30
        const monto = (val02 + val11) * 2 * 46 / 30;
        setResultado(monto);
    };
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={[styles.title, { color: colors.textPrimary }]}>2DA. DE JULIO</Text>
                    <View style={{ width: 40 }} />
                </View>
                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    <View style={[styles.card, { backgroundColor: colors.card }]}>
                        <View style={[styles.cardHeader, { backgroundColor: colors.cardAccent }]}>
                            ...
                            <Text style={styles.cardTitle}>Calculadora 2 de Julio</Text>
                        </View>

                        <View style={styles.cardBody}>
                            <Text style={[styles.description, { color: colors.textSecondary }]}>
                                Ingresa los conceptos <Text style={[styles.bold, { color: colors.textSecondary  }]}>002 </Text> y{' '}
                                <Text style={[styles.bold, { color: colors.textSecondary }]}>011</Text> de tu tarjetón para calcular el pago.
                            </Text>
                            ...
                            >
                                ...
                                <Text style={styles.buttonText}>Calcular Monto</Text>
                            </TouchableOpacity>

                            {resultado !== null && (
                                <View style={[styles.resultContainer, { backgroundColor: colors.cardAccent + '20' }]}>
                                    <Text style={[styles.resultLabel, { color: colors.textSecondary}]}>Monto Estimado:</Text>
                                    <Text style={[styles.resultValue, { color: colors.textSecondary }]}>{formatter(resultado)}</Text>
                                    <Text style={[styles.footerNote, { color: colors.textSecondary }]}>
                                        * Cálculo basado en (002 + 011) x 2 x 46 / 30 días.
                                    </Text>
                                </View>
                            )}
                        </View>
